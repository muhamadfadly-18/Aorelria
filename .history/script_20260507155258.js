...
const calculatorMemories = {
  1: {
    image: "assets/images/memory-photo-01.jpeg",
    title: "Pertama Kali 🌙",
    text: "Aku masih inget pertama kali liat kamu.",
  },

  2: {
    image: "assets/images/memory-photo-02.jpeg",
    title: "Senyum Kecil ✨",
    text: "Senyum kecil kamu ternyata nyangkut terus.",
  },

  3: {
    image: "assets/images/memory-photo-03.jpeg",
    title: "Hujan Malam 💧",
    text: "Malam itu hujan, tapi suasananya hangat.",
  },

  4: {
    image: "assets/images/memory-photo-04.jpeg",
    title: "Tatapan Lucu 🤍",
    text: "Tatapan singkat itu bikin deg-degan.",
  },

  5: {
    image: "assets/images/memory-photo-05.jpeg",
    title: "Obrolan Random ☁️",
    text: "Ngobrol random sama kamu ternyata candu.",
  },

  6: {
    image: "assets/images/memory-photo-06.jpeg",
    title: "Moonlight Night 🌌",
    text: "Kayaknya malam selalu lebih cantik kalau ada kamu.",
  },

  7: {
    image: "assets/images/memory-photo-07.jpeg",
    title: "Little Universe 🌠",
    text: "Dunia kecil ini jadi lebih hidup sejak ada kamu.",
  },

  8: {
    image: "assets/images/memory-photo-08.jpeg",
    title: "Soft Heart 💖",
    text: "Aku suka cara kamu bikin semuanya terasa lembut.",
  },

  9: {
    image: "assets/images/memory-photo-09.jpeg",
    title: "Forever Memory 🥺",
    text: "Kalau suatu hari jadi kenangan, semoga ini yang paling indah.",
  },
};
...
function createCuteEmoji() {
  ...
  for (let i = 0; i < 24; i++) {
    ...
    const distance = Math.random() * 240 + 80;
    ...
    emoji.style.animationDuration = Math.random() * 1.6 + 2.4 + "s";

    emoji.style.rotate = Math.random() * 120 - 60 + "deg";
