...
const memories = [
  { image: "assets/images/mem1.jpg", title: "Pertama Kenal", text: "Hari dimana semua cerita indah ini dimulai..." },
  { image: "assets/images/mem2.jpg", title: "Senyum Kamu", text: "Alasanku kenapa dunia terasa sangat terang." },
  { image: "assets/images/mem3.jpg", title: "Jalan Bareng", text: "Momen sederhana tapi paling berkesan buat aku." },
  { image: "assets/images/mem4.jpg", title: "Foto Lucu", text: "Jangan marah ya, kamu tetep cantik kok di sini!" },
  { image: "assets/images/mem5.jpg", title: "Favorite Place", text: "Tempat dimana kita banyak berbagi cerita." },
  { image: "assets/images/mem6.jpg", title: "I Love You", text: "Hanya ingin bilang kalau aku sayang kamu selamanya." }
];

fruits.forEach((fruit) => {
  fruit.addEventListener("click", () => {
    const index = fruit.dataset.memory;
    ...
    if (memory) {
      ...
      // Tambahkan efek sedikit pudar pada buah yang sudah diklik
      fruit.style.filter = "grayscale(0.5) opacity(0.7)";
